...
public class JwtUtil {
    ...
    public String generateToken(String email, String role) {
        return Jwts.builder()
                .subject(email) // Define o nome de usuário como o assunto do token
                .claim("role", role)
    ...
    public boolean validateToken(String token, String email) {
        ...
        // Verifica se o nome de usuário do token corresponde ao fornecido e se o token não está expirad
